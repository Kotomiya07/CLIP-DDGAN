...
from score_sde.models.clip_embedder import CLIPEmbedder
...
def train(rank, gpu, args):
    ...
    if args.dataset == 'cifar10' or args.dataset == 'stackmnist':    
        netD = Discriminator_small(nc = 2*args.num_channels, ngf = args.ngf,
                                t_emb_dim = args.t_emb_dim, clip_embed_dim=args.clip_embed_dim,
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x, y) in enumerate(data_loader):
            ...
            # get text embedding
            text = clip_embedder.get_text_embedding(y)
            ...
            # train with real
            D_real = netD(x_t, t, x_tp1.detach(), text).view(-1)
            ...
            output = netD(x_pos_sample, t, x_tp1.detach(), text).view(-1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clip_embed_dim', type=int, default=768,
